...
*       4.00   ps    06/03/2014 Inclusão do trecho de teste da função de 
*                               costura e impressão da costura
...
*     "=costura"    - chama a função ARV_CosturaFolhas( )
*     "=imprime"    - chama a função ARV_ImprimeCostura( )
*
***************************************************************************/
   ...
   TST_tpCondRet TST_EfetuarComando( char * ComandoTeste )
   {
      ...
      /* Testar ARV Destruir árvore */
		 ...
		 else if ( strcmp( ComandoTeste , COSTURA_CMD ) == 0 )
         {
			...
			return TST_CompararInt( CondRetEsperada , CondRetObtido ,
                                    "Retorno errado na costura da árvore." );
		 ...
		 else if ( strcmp( ComandoTeste , IMPRIME_COSTURA_CMD ) == 0 )
         {
			...
			return TST_CompararInt( CondRetEsperada , CondRetObtido ,
                                    "Retorno inesperado na função de imprimir a costura." );
