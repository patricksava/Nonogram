...
*		- Número de linhas
*		- Número de colunas
*		- Número de dicas restantes
*		- Vetor de ponteiros para Lista de Valores Horizontais (linhas)
*		- Vetor de ponteiros para Lista de Valores Verticais   (colunas)
*		- Matriz de células de jogo
*
*	O número de linhas e colunas são positivos e variam entre NUM_LINHAS_MINIMO,
*	NUM_LINHAS_MAXIMO, NUM_COLUNAS_MINIMO e NUM_COLUNAS_MAXIMO. (vide o abaixo);
*	O número de dicas varia entre 10(máx) e 0(min);
*	As listas seguem as assertivas estruturais descritas no módulo Lista;
*	A matriz segue as assertivas estruturais descritas no módulo Matriz;
*	Célula e Valor também seguem as assertivas estruturais descritas nos 
*	módulos onde são implementados;
*
***************************************************************************/
...
#define NUM_LINHAS_MAXIMO 20

#define NUM_COLUNAS_MINIMO 5
#define NUM_COLUNAS_MAXIMO 20
...
*    - Número de Linhas e Colunas são inteiros entre NUM_LINHAS_MINIMO,
*	   NUM_LINHAS_MAXIMO, NUM_COLUNAS_MINIMO e NUM_COLUNAS_MAXIMO
*
...
*
*  $ED Descrição da função
*     Imprime o esquema do desenho com os valores e as células marcadas
*
*  $FV Valor retornado
*     DES_CondRetOk
*	  DES_CondRetDesenhoNaoIniciado
...
/***********************************************************************
*
*  $FC Função: DES Deturpa Desenho
*
*  $ED Descrição da função
*     Deturpa o desenho para o modo DEBUG de acordo com a opcao dada
*
*  $AE Assertivas de Entrada
*     - A estrutura desenho deve estar definida
*
*  $AS Assertivas de Saída
*      - O desenho foi deturpado
*
***********************************************************************/
...
*
***********************************************************************/
   DES_tpCondRet DES_Deturpar( int acao );
