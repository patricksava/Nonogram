...
*   Em modo DEBUG: Todo Nó pertencente a uma lista pLista não nula, deve respeitar a seguinte regra: pLista->tipoElemento == pNo->tipoElemento
*
***************************************************************************/
...
***********************************************************************/
   ...
   typedef enum {
		...
		LST_CondRetNoNaoPossuiInfo = 6 ,
		       /* O nó nao possui informacao alguma */
...
/***********************************************************************
*
	*  $FC Função: LST Retorna numero de elementos.
*
*  $EP Parâmetros
...
*
*  $AS Assertivas de Saída
*	Caso a lista seja válida, será retornada um inteiro correspondente ao
*   número de elementos.
*
***********************************************************************/
...
/***********************************************************************
*
*  $FC Função: LST Altera Ponteiro Sucessor.
*
*  $EP Parâmetros
...
*  $AE Assertivas de Entrada
*   Valem as assertivas estrururais da Lista Duplamente Encadeada.
*   Ponteiro pode ser NULL ou válido.
*
*  $AS Assertivas de Saída
*	Lista estará depurtada de acordo com o escolhido.
*
***********************************************************************/
...
/***********************************************************************
*
*  $FC Função: LST Altera Predecessor Sucessor.
*
*  $EP Parâmetros
*     pLista - lista que deseja alterar.
*     ponteiro - ponteiro do tipo void que deseja alterar
...
*
*  $AS Assertivas de Saída
*	Ponteiro para origem da lista é NULL.
*
***********************************************************************/
...
*
*  $AS Assertivas de Saída
*	Ponteiro para nó corrente da lista é NULL.
*
***********************************************************************/
...
/***********************************************************************
*
*  $FC Função: LST Verifica assertiva do ponteiro para próximo elementos
*
*  $EP Parâmetros
...
/***********************************************************************
*
*  $FC Função: LST Verifica assertiva do ponteiro para o elemento anterior
*
*  $EP Parâmetros
*     pLista - lista que deseja verificar.
*
...
/***********************************************************************
*
*  $FC Função: LST Verifica assertivas da Lista Vazia
*
*  $EP Parâmetros
*     pLista - lista que deseja verificar.
*
...
***********************************************************************/
   ...
   /***********************************************************************
*
*  $FC Função: LST Verifica assertivas da Lista com 1 elemento
*
*  $EP Parâmetros
*     pLista - lista que deseja verificar.
*
...
/***********************************************************************
*
*  $FC Função: LST Verifica assertivas da Lista Preenchida
*
*  $EP Parâmetros
*     pLista - lista que deseja verificar.
*
