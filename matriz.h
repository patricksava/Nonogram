...
MAT_tpCondRet MAT_ObterElemento( TpMatriz* matriz, TpNoLista* pos_proc, int* i, int* j);


// BUSCAR O ELEMENTO A PARTIR DA SUA POSICAO a(ij) DADA
MAT_tpCondRet MAT_ObterElemento( TpMatriz* matriz, TpNoLista* elem_proc, int i, int j);


// SUBSTITUIR (ALTERAR) VALOR
MAT_tpCondRet MAT_AlterarValor( TpMatriz* matriz, TpNoLista* elem_subst, int i, int j);
