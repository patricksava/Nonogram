...
*       1.00   mbv   30/mar/2014 Início do desenvolvimento
*
...
*
*     =criar        - chama a função LST_CriarLista( <TpLista> )
*                     Obs. notação: <TpLista>  é o valor do parâmetro
*                     que se encontra no comando de	teste.			
*     =insinicio <Void>
*                   - chama a função LST_InserirNovoNoInicio( <TpLista> , <Void> )
*                     Obs. notação: <Void>  é o valor do parâmetro
*                     que se encontra no comando de teste.
*
*     "=insfim" <Void>
*                    - chama a função LST_InserirNovoNoFim( <TpLista> , <Void> )
*     "=insapos"     - chama a função LST_InserirNoApos( <TpLista> , <Void> )
*     "=insantes"    - chama a função LST_InserirNoAntes( <TpLista> , <Void> )
*     "=libera"      - chama a função LST_LiberarNoCorrente( <TpLista> )
*     "=obter" <Void>
*                    - chama a função LST_ObterValor( <TpLista> , <Void> ) e compara
*                     o valor retornado com o valor <Void>
*     "=alterar"     - chama a função LST_AlterarValor( <TpLista> , <Void> )
*     "=irinicio"    - chama a função LST_IrInicio( <TpLista> )
*     "=irfim"       - chama a função LST_IrFim( <TpLista> )
*     "=avancar"     - chama a função LST_Avancar( <TpLista> , <int> )
*     "=destroi"     - chama a função LST_DestruirLista( <TpLista> )
*
***************************************************************************/
...
/***********************************************************************
*
*  $FC Função: TARV Efetuar operações de teste específicas para lista
*
